...
import { AnalyticsIcon } from '../../data/icons';
import dataAnalyticsCards from '../../data/services/dataAnalytics';

export default function DataAnalytics() {
  useEffect(() => {
    document.title = 'Data Analytics | The Hillen Group';
  ...
  return (
    <main className="bg-bg text-dark">
      ...
      <PageHero
        ...
        subtitle="Warehouses, BI, ML, governance, and streaming—end-to-end analytics platforms that teams trust."
        icon={<AnalyticsIcon className="h-10 w-10" />}
      ...
      <section className="max-w-7xl mx-auto px-4 pb-16">
        <ul
          ...
          data-aos-delay="100"
        >
          {dataAnalyticsCards.map(({ id, title, desc, Icon }, i) => (
            <li
              key={id}
              id={id}
