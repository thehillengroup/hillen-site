...
// hero icon
import { PlanningIcon } from '../../data/icons';

// cards data for this page
import planningCards from '../../data/services/projectPlanning';

export default function ProjectPlanning() {
  useEffect(() => {
    document.title = 'Project Planning & Discovery | The Hillen Group';
  ...
  return (
    <main className="bg-bg text-dark">
      ...
      <PageHero
        ...
        title={
          <>
            Project Planning <span className="text-accent">& Discovery</span>
          </>
        }
        subtitle="Roadmaps, discovery, prioritization, risk & dependency management, and governance aligned to business value."
        icon={<PlanningIcon className="h-10 w-10" />}
      ...
      <section className="max-w-7xl mx-auto px-4 pb-16">
        <ul
          ...
          data-aos-delay="100"
        >
          {planningCards.map(({ id, title, desc, Icon }, i) => (
            <li
              key={id}
              id={id}
